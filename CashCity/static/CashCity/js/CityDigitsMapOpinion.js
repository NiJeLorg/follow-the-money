...
function CityDigitsMapOpinion(id, lat, lon, zoom) {
    ...
    this.map = L.mapbox.map('map_'+id, basemap,{minZoom:10,maxZoom:16,zoomControl:false}).setView([lat,lon], zoom);
    //load zoomer
    $(".citydigits-zoomer").on("click","#zoom-in",CityDigitsMapOpinion.onZoomIn);
    $(".citydigits-zoomer").on("click","#zoom-out",CityDigitsMapOpinion.onZoomOut);
...
CityDigitsMapOpinion.onZoomIn = function(event){
    MY_MAP.map.zoomIn();
}

CityDigitsMapOpinion.onZoomOut = function(event){
    MY_MAP.map.zoomOut();
}


CityDigitsMapOpinion.onEachFeature_MAP1_POP_POVERTY = function(feature,layer){	
	var highlight = {
	    weight: 3,
	    opacity: 1
	};
...
CityDigitsMapOpinion.onEachFeature_MAP2_MED_HH_INCOME = function(feature,layer){
	var highlight = {
	    weight: 3,
	    opacity: 1
	};
...
CityDigitsMapOpinion.onEachFeature_MAP3_PCT_UNEMPLOYED = function(feature,layer){
	var highlight = {
	    weight: 3,
	    opacity: 1
	};
...
CityDigitsMapOpinion.onEachFeature_MAP4_PCT_FOREIGN_BORN = function(feature,layer){
	var highlight = {
	    weight: 3,
	    opacity: 1
	};
...
CityDigitsMapOpinion.onEachFeature_CREATEMAP1_AFI_PER_SQMILE = function(feature,layer){
	var highlight = {
	    weight: 3,
	    opacity: 1
	};
...
CityDigitsMapOpinion.onEachFeature_CREATEMAP2_BANKS_PER_SQMILE = function(feature,layer){
	var highlight = {
	    weight: 3,
	    opacity: 1
	};
...
CityDigitsMapOpinion.onEachFeature_CREATEMAP3_PAWN_SHOPS_PER_SQMILE = function(feature,layer){
	var highlight = {
	    weight: 3,
	    opacity: 1
	};
...
CityDigitsMapOpinion.onEachFeature_CREATEMAP4_MCDONALDS_PER_SQMILE = function(feature,layer){
	var highlight = {
	    weight: 3,
	    opacity: 1
	};
...
CityDigitsMapOpinion.onEachFeature_CREATEMAP5_HH_PER_AFI = function(feature,layer){
	var highlight = {
	    weight: 3,
	    opacity: 1
	};
...
CityDigitsMapOpinion.onEachFeature_CREATEMAP6_HH_PER_BANK = function(feature,layer){
	var highlight = {
	    weight: 3,
	    opacity: 1
	};
...
CityDigitsMapOpinion.onEachFeature_CREATEMAP7_HH_PER_MCDONALDS = function(feature,layer){
	var highlight = {
	    weight: 3,
	    opacity: 1
	};
...
CityDigitsMapOpinion.onEachFeature_CREATEMAP8_HH_PER_PAWN_SHOP = function(feature,layer){
	var highlight = {
	    weight: 3,
	    opacity: 1
	};
...
CityDigitsMapOpinion.onEachFeature_CREATEMAP9_AFIS_PER_BANK = function(feature,layer){
	var highlight = {
	    weight: 3,
	    opacity: 1
	};
...
CityDigitsMapOpinion.onEachFeature_CREATEMAP10_BANKS_PER_AFI = function(feature,layer){
	var highlight = {
	    weight: 3,
	    opacity: 1
	};
...
CityDigitsMapOpinion.prototype.loadCreateMapLayers = function (callBack){
    var self = this;
	...
	this.CREATEMAP1_AFI_PER_SQMILE_style = L.geoJson(null, {
		...
		onEachFeature: CityDigitsMapOpinion.onEachFeature_CREATEMAP1_AFI_PER_SQMILE
	});
	this.CREATEMAP2_BANKS_PER_SQMILE_style = L.geoJson(null, {
		...
		onEachFeature: CityDigitsMapOpinion.onEachFeature_CREATEMAP2_BANKS_PER_SQMILE
	});
	this.CREATEMAP3_PAWN_SHOPS_PER_SQMILE_style = L.geoJson(null, {
		...
		onEachFeature: CityDigitsMapOpinion.onEachFeature_CREATEMAP3_PAWN_SHOPS_PER_SQMILE
	});
	...
	this.CREATEMAP7_HH_PER_MCDONALDS_style = L.geoJson(null, {
		...
		onEachFeature: CityDigitsMapOpinion.onEachFeature_CREATEMAP7_HH_PER_MCDONALDS
	});
...
CityDigitsMapOpinion.onEachFeatureFor_LOC1_PAWN_SHOPS = function(feature,layer){
	var highlight = {
		stroke: true,
	    color: '#ffffff', 
	    weight: 3,
...
CityDigitsMapOpinion.onEachFeatureFor_LOC2_CHECK_CASHING = function(feature,layer){	
	var highlight = {
		stroke: true,
	    color: '#ffffff', 
	    weight: 3,
...
CityDigitsMapOpinion.onEachFeatureFor_LOC3_WIRE_TRANSFER = function(feature,layer){
	var highlight = {
		stroke: true,
	    color: '#ffffff', 
	    weight: 3,
...
CityDigitsMapOpinion.onEachFeatureFor_LOC4_BANKS = function(feature,layer){
	var highlight = {
		stroke: true,
	    color: '#ffffff', 
	    weight: 3,
...
CityDigitsMapOpinion.onEachFeatureFor_LOC5_MCDONALDS = function(feature,layer){
	var highlight = {
		stroke: true,
	    color: '#ffffff', 
	    weight: 3,
...
CityDigitsMapOpinion.onEachFeatureFor_LOC6_SUBWAY_LINES = function(feature,layer){
...
CityDigitsMapOpinion.onEachFeatureFor_MEDIA_IMAGES = function(feature, layer){
...
CityDigitsMapOpinion.onEachFeatureFor_MEDIA_AUDIO = function(feature, layer){
...
CityDigitsMapOpinion.onEachFeatureFor_MEDIA_NOTE = function(feature, layer){
...
CityDigitsMapOpinion.onEachFeatureFor_MEDIA_INTERVIEW = function(feature, layer){
...
CityDigitsMapOpinion.prototype.loadMedia = function(){
	...
	this.MEDIA_IMAGES = L.geoJson(mediaImageGeojson, {
		pointToLayer: CityDigitsMapOpinion.getStyleFor_MEDIA,
		onEachFeature: CityDigitsMapOpinion.onEachFeatureFor_MEDIA_IMAGES
	});
	// define layer styles and oneachfeature popup styling
	this.MEDIA_AUDIO = L.geoJson(mediaAudioGeojson, {
		pointToLayer: CityDigitsMapOpinion.getStyleFor_MEDIA,
		onEachFeature: CityDigitsMapOpinion.onEachFeatureFor_MEDIA_AUDIO
	});
	// define layer styles and oneachfeature popup styling
	this.MEDIA_NOTE = L.geoJson(mediaNoteGeojson, {
		pointToLayer: CityDigitsMapOpinion.getStyleFor_MEDIA,
		onEachFeature: CityDigitsMapOpinion.onEachFeatureFor_MEDIA_NOTE
	});
	// define layer styles and oneachfeature popup styling
	this.MEDIA_INTERVIEW = L.geoJson(mediaInterviewGeojson, {
		pointToLayer: CityDigitsMapOpinion.getStyleFor_MEDIA,
		onEachFeature: CityDigitsMapOpinion.onEachFeatureFor_MEDIA_INTERVIEW
	});
...
CityDigitsMapOpinion.loadLayerFor = function(layerId){
    ...
    if(layerId == "MAP1"){
		...
		CityDigitsMapOpinion.drawChartOnSwap();
	 }	
    if(layerId == "MAP2"){
...
CityDigitsMapOpinion.loadLocationsLayerFor = function(layerId){
...
CityDigitsMapOpinion.loadMediaLayerFor = function(layerId){
	// add layer requested based on ID
	if (layerId == "MEDIA") {
...
CityDigitsMapOpinion.removeLayerFor = function(layerId){
...
CityDigitsMapOpinion.drawChart = function(layerId){
	...
	d3.json(neighborhoods, function(error, data) {
	  ...
	  svg.selectAll(".bar")
	    ...
	    .enter().append("rect")
		  ...
		  .on("click", function(d) {
			  CityDigitsMapOpinion.zoomToNeighborhoodAndPopup(d.properties.Name);
		  })
	  	...
	  	$('#chartCloseButton').click(function() {
	  		...
	  		// remove chart
	  		CityDigitsMapOpinion.removeChart(layerId);
	  	});
...
CityDigitsMapOpinion.removeChart = function(layerId){
	$( "#svgChart" ).remove();
	...
	$('#chart').click(function() {
		...
		if (!mainChart) {
			// draw chart
			CityDigitsMapOpinion.drawChart(layerId);
		}		
	});
...
CityDigitsMapOpinion.drawChartOnSwap = function() {
...
CityDigitsMapOpinion.zoomToNeighborhoodAndPopup = function(neighborhoodName) {
	var layerArray = [];
	...
	$.each(layerArray, function(index, layer){
		if (layer.feature.properties.Name == neighborhoodName) {
			...
			// get popup content
			var layerId = mainLayer._leaflet_id;
			var popupContent = CityDigitsMapOpinion.setPopUpContent(layer, layerId);	
...
CityDigitsMapOpinion.setPopUpContent = function(layer,layerId) {
